...
class LengthSelector(BaseSelector):
    def __init__(self, 
        ...
        super(LengthSelector, self).__init__(source_dir, target_dir, source_file_path, target_file_path)
    ...
    def __process__(self, data):
        for d in tqdm(data):
            ...
            for instance in instances:
                if len(instance["output"]) < self.min_response_length or len(instance["output"]) > self.max_response_length:
