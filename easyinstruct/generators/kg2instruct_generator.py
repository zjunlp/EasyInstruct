...
class KG2InstructGenerator(BaseGenerator):
    def __init__(self, label_db, alias_db, alias_rev_db, relation_db, relation_map_path, model, language="zh", relation_value_db="", add_relation_value=False, device=0, chunk=5):
        super().__init__()
