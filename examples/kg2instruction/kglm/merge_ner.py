...
from kglm.util import add_space, remove_space, containEnglish, clean_u200b, format_wikilink, load_already
logger = logging.getLogger(__name__)

BAD = [
    "CARDINAL", "ORDINAL", "LANGUAGE", "MONEY", "PERCENT", "LANGUAGE", "NORP", "TIME"
]
MED = [
    "DATE", "QUANTITY",
]
