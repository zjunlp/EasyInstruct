...
- [KG2Instruction全流程](#kg2instruction全流程)
  - [1.构建一些必要的映射](#1构建一些必要的映射)
  - [2.获得文本语料](#2获得文本语料)
    - [下载HTML格式的Wikipedia文章(可跳过)](#下载html格式的wikipedia文章可跳过)
    - [清洗Wikipedia文章(可跳过)](#清洗wikipedia文章可跳过)
  - [3.按段落划分Wikipedia文章, 得到初步实体ID与中文标签](#3按段落划分wikipedia文章-得到初步实体id与中文标签)
  - [4.通过hanlp识别剩余实体](#4通过hanlp识别剩余实体)
  - [5.合并3、4中的实体](#5合并34中的实体)
  - [6.实体消歧,获得唯一ID](#6实体消歧获得唯一id)
  - [7.匹配每对实体间的所有关系](#7匹配每对实体间的所有关系)
  - [8.获取实体类型](#8获取实体类型)
  - [9.文本主题分类](#9文本主题分类)
  - [10.应用schema约束关系](#10应用schema约束关系)
  - [11.应用IE-LLM补齐因KG不完整性缺少的三元组](#11应用ie-llm补齐因kg不完整性缺少的三元组)
  - [12.NLI模型过滤](#12nli模型过滤)
